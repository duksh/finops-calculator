...
- [ ] Introduce `src/core/` runtime shell helpers
- [ ] Extract pure economics helpers from `index.html` into `src/core/economics.js`
- [ ] Add compatibility adapter so current page behavior is unchanged
